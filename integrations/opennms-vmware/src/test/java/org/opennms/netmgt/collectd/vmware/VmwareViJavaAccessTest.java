...
public class VmwareViJavaAccessTest {
    ...
    public void setUp() throws Exception {
        ...
        whenNew(ServiceInstance.class).withParameterTypes(URL.class, String.class, String.class).withArguments(new URL(""), "username", "password").thenReturn(mockServiceInstance);
        ...
        when(mockAboutInfo.getApiVersion()).thenReturn("2.x");
        when(mockAboutInfo.getApiVersion()).thenReturn("3.x");
        when(mockAboutInfo.getApiVersion()).thenReturn("4.x");
        when(mockAboutInfo.getApiVersion()).thenReturn("5.x");
        when(mockAboutInfo.getApiVersion()).thenReturn("6.x");
        when(mockAboutInfo.getApiVersion()).thenReturn("x");
    ...
    public void tearDown() throws Exception {
        ...
        verifyNoMoreInteractions(mockServerConnection);
